...
public final class CoprocessMiniRequestObject {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!internalGetSetHeaders().equals(
          other.internalGetSetHeaders())) return false;
      if (!getDeleteHeadersList()
          .equals(other.getDeleteHeadersList())) return false;
      if (!getBody()
      ...
      if (!internalGetAddParams().equals(
          other.internalGetAddParams())) return false;
      if (!internalGetExtendedParams().equals(
          other.internalGetExtendedParams())) return false;
      if (!getDeleteParamsList()
          .equals(other.getDeleteParamsList())) return false;
      if (hasReturnOverrides() != other.hasReturnOverrides()) return false;
      if (hasReturnOverrides()) {
        if (!getReturnOverrides()
            .equals(other.getReturnOverrides())) return false;
      }
      if (!getMethod()
